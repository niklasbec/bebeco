  ...
  return (
    <div className="Home">
      ...
      <div className="benefits">
        <Adv url="https://image.flaticon.com/icons/svg/1535/1535012.svg" h3="für kleine Unternehmen optimiert" p="Im Gegensatz zu anderen Dienstleistern bieten wir faire Konditionen, unabhängig der Größe Ihres Unternehmens, damit Sie mit uns wachsen können."/>
